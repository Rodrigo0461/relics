        ...
        <div class="et-inner">
            ...
            <div class="et-center clr" style="border: 1px solid #DDDDDD;">
               ...
               <div class="input" id="rut-client-div">
                    <label for="type" style="text-align: left;" id="rut-client-lbl">Financiador</label>
                    <input type="text" class="inptwidth1 financiador_search ui-autocomplete-input" maxlength="20" id="financiador" value="" name="financiador">
                </div>

                <div class="input">
                    <input type="button" value="Buscar" id="date_search" class="btn">
                </div>
            </div>
        </div>
    </div>
